...
import lock from "../assets/padlock 1.svg";
...
function Register(props) {
  ...
  return (
    <div id="register" className="relative sm:px-10 sm:pb-8 sm:pt-5 lg:pt-[3%] lg:pb-[5.5%] sm:opacity-90 bg-white sm:border sm:border-[#CDCDCD] sm:shadow-[0_1px_4px_0_rgba(0,0,0,0.25)] max-h-full w-full sm:w-full sm:h-full rounded-3xl">
      <form onSubmit={handleSubmit}>
        ...
        <div className="max-h-[40vh] 3xl:max-h-[250px] grid gap-[10%] mt-[1%] overflow-y-scroll scrollbar-thin scrollbar-thumb-[rgba(153,153,153,0.27)] hover:scrollbar-thumb-[#999999] scrollbar-track-[rgba(254,254,254,0.5)] scrollbar-thumb-rounded-xl">
          <div className="">
            ...
            <div className="relative">
              ...
              <input
                className="w-full mt-[2%] outline-none pl-6 pb-1 border-b border-b-black focus:border-b-2"
                name="email"
                type="email"
          ...
          <div className="">
            ...
            <div className="relative">
              ...
              <input
                className="w-full mt-[2%] mb-1 outline-none pl-6 pb-1 border-b border-b-black focus:border-b-2"
        ...
        <button
          className="w-full mt-5 lg:mt-[3%] -mb-1 text-white bg-[#22A6B3] py-3 font-bold rounded-full hover:bg-[#1A7F89]"
