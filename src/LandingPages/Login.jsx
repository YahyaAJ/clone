...
function Login(props) {
  ...
  return (
    <div id="login" className="relative sm:px-10 sm:py-10 sm:opacity-90 bg-white sm:border sm:border-[#CDCDCD] sm:shadow-[0_1px_4px_0_rgba(0,0,0,0.25)] max-h-full w-full sm:w-[515px] sm:h-[495px] sm:rounded-[30px]">
